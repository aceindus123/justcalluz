<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_events.aspx.cs" Inherits="edit_events" %>
...
<div class="content_innermid">
 <div class="contentmid_boxtop"><asp:HyperLink ID="hyplink" runat="server" NavigateUrl="<%$RouteUrl:RouteName=HomeRoute %>" Text="Home" 
       Font-Underline="false" ForeColor="White"></asp:HyperLink>&gt;&gt;Edit The Event </div>
    ...
    <table width="100%" border="0" style="background-color:#D9EBFD;  border:dotted 1px #666">
      ...
      <asp:RequiredFieldValidator ID="reqsubcat" runat="server" ControlToValidate="ddlsubcat" 
          ...
          InitialValue="select">*</asp:RequiredFieldValidator>
           ...
           Height="21px" Width="196px" OnSelectedIndexChanged="ddlstate_selectedindexchanged"></asp:DropDownList>
      <asp:RequiredFieldValidator ID="reqstate" runat="server" 
          ...
          ValidationGroup="postevent" InitialValue="select">*</asp:RequiredFieldValidator>
           ...
           Height="21px" 
          Width="196px" ValidationGroup="events"></asp:DropDownList>
      <asp:RequiredFieldValidator ID="reqcity" runat="server" 
          ...
          Width="196px" ValidationGroup="events" onkeypress="return Alphabets(event);"></asp:TextBox>
      <asp:RequiredFieldValidator ID="reqara" runat="server" 
          ...
          Width="196px" ValidationGroup="events" ></asp:TextBox>
      ...
      <asp:RequiredFieldValidator ID="reqind" runat="server" 
          ErrorMessage="Please enter the venue " ControlToValidate="txtven"  ValidationGroup="postevent">*</asp:RequiredFieldValidator></td>
                  ...
                  <tr>
                    <td align="right" class="style10"><span class="star">*</span><span class="list">Type of Event</span></td>
                    <td align="center"><strong>:</strong></td>
                    <td height="30" align="left"><span class="row">
  ...
  <td align="left">
      <asp:TextBox ID="txtone" runat="server" Visible="false" Height="20px" 
          Width="98px" ValidationGroup="events"></asp:TextBox>
      ...
      <%--<asp:RangeValidator ID="rngmulti" runat="server" 
          ...
          ErrorMessage="Please enter the end date" ControlToValidate="txtone"  ValidationGroup="postevent">*</asp:RequiredFieldValidator>
      </td>
     ...
     <%--<AjaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender3" runat="server" TargetControlID="txtsub" WatermarkText="Enter Subcategory">
     </AjaxToolkit:TextBoxWatermarkExtender>  --%> 
  </tr>
          ...
          Width="196px" TextMode="MultiLine" ValidationGroup="events"></asp:TextBox>
      ...
      <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" 
          ErrorMessage="Enter the address" ControlToValidate="txtadd"  ValidationGroup="postevent">*</asp:RequiredFieldValidator></td>
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtlndm" runat="server" Height="20px" Width="196px"></asp:TextBox></td>
                  </tr>
                  <tr>
                    <td align="right" class="style10"><span class="star">*</span> <span class="list">Pincode</span></td>
                    <td align="center"><strong>:</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtpin" runat="server" Height="20px" Width="196px" onkeypress="return onlyNos(event,this);" MaxLength="6"></asp:TextBox>
  <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
      ...
      <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
          ErrorMessage="Enter mobile number only 6 digits(starting number should starts from 1 to 9 digits)" ControlToValidate="txtpin" 
          ValidationExpression="^[01]?[- .]?(\([1-9]\d{1}\)|[1-9]\d{1})[- .]?\d{2}[- .]?\d{2}$" Display="Dynamic" ValidationGroup="postevent"></asp:RegularExpressionValidator>  
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtcntp" runat="server" Height="20px" Width="196px" onkeypress="return Alphabets(event);"></asp:TextBox>
      ...
      <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
          ...
          ValidationGroup="postevent" ControlToValidate="txtemail" >*</asp:RegularExpressionValidator></td>
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtph" runat="server" Height="20px"  Width="196px" onkeypress="return onlyNos(event,this);" MaxLength="11">
                      </asp:TextBox>
          ...
          ControlToValidate="txtph" ErrorMessage="Enter mobile number only ten digits(starting number should starts from 1 to 9 digits)" 
          ValidationExpression="^[01]?[- .]?(\([1-9]\d{2}\)|[1-9]\d{2})[- .]?\d{3}[- .]?\d{4}$"></asp:RegularExpressionValidator><b class="side_menu">(Eg:-04066136226)</b></td>
                  </tr>
                  <tr>
          ...
          Width="196px" MaxLength="10" onkeypress="return onlyNos(event,this);" ValidationGroup="events"></asp:TextBox>
         ...
         <%--<asp:RangeValidator ID="RangeValidator1" runat="server" 
          ...
          ValidationExpression="^[01]?[- .]?(\([1-9]\d{2}\)|[1-9]\d{2})[- .]?\d{3}[- .]?\d{4}$" Display="Dynamic"></asp:RegularExpressionValidator><b class="side_menu">(Eg:-9000465921)</b></td>
                  </tr>
                  
                  <tr>
                    <td align="right" class="style10"><span class="list">fax</span></td>
                    <td align="center"><strong>:</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtfax" runat="server" Height="20px" Width="196px" onkeypress="return onlyNos(event,this);" MaxLength="11"></asp:TextBox>
   <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
          ...
          ValidationExpression="\d{11}">*</asp:RegularExpressionValidator>
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td height="30" align="left"> <asp:TextBox ID="txtweb" runat="server" Height="20px" Width="196px"></asp:TextBox>
      ...
      <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
          ValidationGroup="postevent" ShowMessageBox="True" ShowSummary="False" /></td>
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td height="30" align="left" class="side_menu"><asp:FileUpload ID="photo" runat="server" /><br />
                      <b class="side_menu">Invitation must be 250x300 with less than 100kb of size</b>  </td>
                  </tr>
                      ...
                      <tr>
                        <td width="36%" align="right" height="40" style="padding-right:3px;">
                         <asp:ImageButton ID="updatebtn" runat="server" ImageUrl="../images/update.png"
                              onclick="updatebtn_Click" ValidationGroup="postevent" AlternateText="btnUpdate" /></td>
                        
                        <td width="40%" align="left">
                          <asp:ImageButton ID="cancel" AlternateText="btnCancel" runat="server" ImageUrl="../images/cancel-button.png" onclick="cancel_Click"/>
                        </td>
                      </tr>
                    </table></td>
                    </tr>
