<%@ Page Language="C#" AutoEventWireup="true" CodeFile="post_discount.aspx.cs" Inherits="post_discount" %>
...
<%--<title>:: Justcalluz :: Post Discount page</title>--%>
  ...
  <tr>
    <td valign="top" align="center"> 
     <div>
              ...
              <tr>
                <td height="30" align="center" valign="top">
                 <table width="100%" border="0" bgcolor="">
                  <tr>
                    <td align="right" style="width:35%;"><span class="star">*</span><span class="list">Category</span></td>
                    <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                    <td height="30" align="left" style="width:65%;">
                       <asp:DropDownList ID="ddlCategory" runat="server" Height="21px" 
                         Width="196px" AutoPostBack="true" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged"></asp:DropDownList>
                  ...
                  <tr id="trSubcat" runat="server">
                    ...
                    <td height="30" align="left">
                       <asp:DropDownList ID="ddlSubcat" runat="server" Height="21px" 
                         Width="196px"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="rfvddlSubcat" runat="server" 
                            ErrorMessage="please select the SubCategory" Text="*" ControlToValidate="ddlSubcat" 
                            ValidationGroup="validatediscount" InitialValue="select">*</asp:RequiredFieldValidator>
                 ...
                 <tr>
                   ...
                   <tr>
                    ...
                    <td height="30" align="left">
                      <asp:DropDownList ID="ddltyp" runat="server" AutoPostBack="true" Height="21px" 
                          Width="196px" ValidationGroup="events" OnSelectedIndexChanged="ddltyp_selectedIndexChanged">
                   ...
                   <tr>
                    ...
                    <td height="30" align="left">
                     <asp:DropDownList ID="ddlstate" runat="server" AutoPostBack="true" 
                          Height="21px" 
                       Width="196px" OnSelectedIndexChanged="ddlstate_selectedindexchanged"></asp:DropDownList>
                  ...
                  <tr>
                    ...
                    <asp:TextBox ID="txtcode" runat="server" ReadOnly="true" Text="+91" Width="30px"></asp:TextBox>-
                       <asp:TextBox ID="txtmob" runat="server" Width="155px" onkeypress="return onlyNos(event,this);" MaxLength="10"></asp:TextBox>
                  ...
                  <tr>
                    <td align="right">&nbsp;</td>
                    <td align="center">&nbsp;</td>
                    <td align="left"><b class="side_menu">(E.g:- 09000465921)</b></td>
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                    <td height="30" align="left">
                      <asp:TextBox ID="txtlandline" runat="server" MaxLength="10" onkeypress="return onlyNos(event,this);" Width="196px"></asp:TextBox>            
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtfax" runat="server" Width="196px" onkeypress="return onlyNos(event,this);" MaxLength="11"></asp:TextBox>
                   ...
                   <tr>
                    ...
                    <td align="right">&nbsp;</td>
                    <td align="center">&nbsp;</td>
                    <td align="left"><b class="side_menu">(E.g:- http://www.Justcalluz.com )</b></td>
                    ...
                    <table width="100%" border="0">
                      <tr>
                        <td width="36%" align="right" height="40" style="padding-right:3px;">
                         <asp:ImageButton ID="postimg" runat="server" ImageUrl="images/post-button.png" 
                              onclick="post_discount_Click" ValidationGroup="validatediscount" />
                        </td>
                        <td width="24%" align="center">
                         <asp:ImageButton ID="view" runat="server" ImageUrl="images/view-discount.png" 
                                  PostBackUrl="<%$RouteUrl:RouteName=ViewDiscount%>" AlternateText="ViewDiscounts"/>
                          <%--<asp:ImageButton ID="view" runat="server" ImageUrl="images/view-discount.png" 
                                  PostBackUrl="view_discounts.aspx" AlternateText="ViewDiscounts"/>--%>
                        </td>
                        <td width="40%" align="left">
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="images/cancel-button.png" AlternateText="btnCancel" 
                                  PostBackUrl="<%$RouteUrl:RouteName=discounts,cname=discounts%>" />
                        <%--<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="images/cancel-button.png" AlternateText="btnCancel" PostBackUrl="Discounts.aspx?cname=discounts" />--%>
                        </td>
                      </tr>
                    </table>
                    </td>
      ...
      <tr id="trlblintimation" runat="server">
      <td align="center">
      <table id="tblintimation" runat="server">
      <tr><td>
      <asp:Label ID="lblintimation" runat="server" Text="Do you want to post more information like Timings,upload logo,Upload Photos,Upload vedios etc.,?" Font-Bold="true"
       ForeColor="Green" Font-Names="Monotype corsiva" Font-Size="X-Large" BorderColor="Green" ></asp:Label></td></tr>
       <tr><td></td></tr>
       <tr><td>
       <asp:ImageButton ID="imgbutclickhere" runat="server" 
               ImageUrl="images/Click-here.png" AlternateText="Click_here" onclick="imgbutclickhere_Click" />
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <asp:ImageButton ID="imgbutnothanks" runat="server" AlternateText="No_Thanks" 
               ImageUrl="images/No-Thanks.png" onclick="imgbutnothanks_Click" />
      </td></tr>
      </table>
  </td>
  </tr>
  ...
  <fieldset>
    <table width="100%">
        <tr>
            ...
            <td>
            <asp:ImageButton ID="btnUploadLogo" runat="server" AlternateText="UploadLogo" 
        ...
        <td colspan="2"></td>
        <td colspan="2">
          <asp:Image ID="ImgLogo" runat="server" Width="100px" Height="75px" AlternateText="Logos" ImageUrl='<%# Eval("ImageName", "../Logos\\{0}") %>' />    
        ...
        <tr>
            ...
            <td>
                <asp:FileUpload ID="uploadPhotos" runat="server" />
                 <b style="color:#093; font-size:11px;">Photo must be 250x300 with less than 100kb of size</b>
            </td>
            <td>
            <asp:ImageButton ID="btnUploadPhotos" runat="server" 
                    ImageUrl="images/Upload-Photos.png" AlternateText="UploadPhotos" onclick="btnUploadPhotos_Click1" />
            </td>
        </tr>
        <tr>
        <td colspan="4"></td>
        ...
        <tr>
          <td width="100%" colspan="4">
            <table width="100%" id="HRO">
                <tr><td>More Information</td></tr>
                <tr>
                    <td>
                         <table width="100%">
                            <tr><td colspan="3">Hours Of Operation</td></tr>
                          <tr>
                          <td class="adminform" align="right">Monday</td>
                          <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                          <td>
                          ...
                          <tr id="trMonDur" runat="server">
                              ...
                              <td valign="middle">
                                  ...
                                  &nbsp;<%--<asp:LinkButton ID="lnkMonTimings" runat="server" ForeColor="Red" 
                                      onclick="lnkMonTimings_Click">Add Timings</asp:LinkButton>--%><a id="lnkMonTimings" runat="server" style="color:Red;" onserverclick="lnkMonTimings_Click">Add Timings</a>                                                                                                                                                                             
                          ...
                          <tr>
                          <td class="adminform" align="right">Tuesday</td>
                          <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                          <td>
                          ...
                          <tr id="trTuesDur" runat="server">
                              ...
                              <td valign="middle">
                                  ...
                                  &nbsp;<%--<asp:LinkButton ID="lnkTuesTimings" runat="server" ForeColor="Red" 
                                      onclick="lnkTuesTimings_Click">Add Timings</asp:LinkButton>--%><a id="lnkTuesTimings" runat="server" style="color:Red;" onserverclick="lnkTuesTimings_Click">Add Timings</a>                                                                                                                                                                             
                          ...
                          <tr>
                          <td class="adminform" align="right">Wednesday</td>
                          <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                          <td>
                              <asp:DropDownList ID="ddlWednesday" runat="server" 
                                  AutoPostBack="true" onselectedindexchanged="ddlWednesday_SelectedIndexChanged">
                              <asp:ListItem Value="Select">Select</asp:ListItem>
                              <asp:ListItem Value="Holiday">Holiday</asp:ListItem>  
                              <asp:ListItem Value="Open 24Hrs">Open 24Hrs</asp:ListItem>
                              <asp:ListItem Value="Time Duration">Time Duration</asp:ListItem>
                          ...
                          <tr id="trWedDur" runat="server">
                              ...
                              <td valign="middle">
                                  ...
                                  &nbsp;<%--<asp:LinkButton ID="lnkWedTimings" runat="server" ForeColor="Red" onclick="lnkWedTimings_Click" 
                                     >Add Timings</asp:LinkButton>--%><a id="lnkWedTimings" runat="server" style="color:Red;" onserverclick="lnkWedTimings_Click">Add Timings</a>                                                                                                                                                                             
                          ...
                          <tr>
                          <td class="adminform" align="right">Thursday</td>
                          <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                          <td>
                          ...
                          <tr id="trThursDur" runat="server">
                              ...
                              <td valign="middle">
                                  ...
                                  &nbsp;<%--<asp:LinkButton ID="lnkThursTimings" runat="server" ForeColor="Red" onclick="lnkThursTimings_Click" 
                                     >Add Timings</asp:LinkButton>--%><a id="lnkThursTimings" runat="server" style="color:Red;" onserverclick="lnkThursTimings_Click">Add Timings</a>                                                                                                                                                                             
                          ...
                          <tr>
                          <td class="adminform" align="right">Friday</td>
                          <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                          <td>
                          ...
                          <tr id="trFriDur" runat="server">
                              ...
                              <td valign="middle">
                                  ...
                                  &nbsp;<%--<asp:LinkButton ID="lnkFriTimings" runat="server" ForeColor="Red" onclick="lnkFriTimings_Click" 
                                     >Add Timings</asp:LinkButton>--%><a id="lnkFriTimings" runat="server" style="color:Red;" onserverclick="lnkFriTimings_Click">Add Timings</a>                                                                                                                                                                             
                          ...
                          <tr>
                          <td class="adminform" align="right">Saturday</td>
                          <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                          <td>
                          ...
                          <tr id="trSatDur" runat="server">
                              ...
                              <td valign="middle">
                                  ...
                                  &nbsp;<%--<asp:LinkButton ID="lnkSaturTimings" runat="server" ForeColor="Red" onclick="lnkSaturTimings_Click" 
                                     >Add Timings</asp:LinkButton>--%><a id="lnkSaturTimings" runat="server" style="color:Red;" onserverclick="lnkSaturTimings_Click">Add Timings</a>                                                                                                                                                                             
                          ...
                          <tr id="trLstSatur" runat="server">
                            ...
                            <table><tr><td>
                             ...
                             <%-- <asp:LinkButton ID="lnkBtnClearSatTimings" runat="server" ForeColor="Red" onclick="lnkBtnClearSatTimings_Click">Clear Timings</asp:LinkButton> --%> 
                          ...
                          <tr>
                          <td class="adminform" align="right">Sunday</td>
                          <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                          <td>
                          ...
                          <tr id="trSunDur" runat="server">
                              ...
                              <td valign="middle">
                                  ...
                                  &nbsp;<%--<asp:LinkButton ID="lnkSunTimings" runat="server" ForeColor="Red" 
                                             onclick="lnkSunTimings_Click">Add Timings</asp:LinkButton>--%><a id="lnkSunTimings" runat="server" style="color:Red;" onserverclick="lnkSunTimings_Click">Add Timings</a>                                                                                                                                                                             
                          ...
                          <tr><td colspan="3">Payment Modes</td></tr>
                          ...
                          <tr><td colspan="3">Additional Information</td></tr>
                          ...
                          <td><strong>&nbsp;:&nbsp;</strong></td>
                          <td align="left">
                          <asp:DropDownList ID="ddlyearestablish" runat="server" Width="193px"></asp:DropDownList></td>
                          </tr>
                          <tr><td style="font-family:Arial" align="right">Professional Association</td>
                          <td><strong>&nbsp;:&nbsp;</strong></td>
                          <td align="left"><asp:TextBox ID="txtprofass" runat="server" Width="192px"></asp:TextBox></td>
                          </tr>
                          <tr>
                          <td style="font-family:Arial" align="right">Certification</td>
                          <td><strong>&nbsp;:&nbsp;</strong></td>
                          <td align="left"><asp:TextBox ID="txtcertificate" runat="server" Width="192px"></asp:TextBox></td>
                          </tr>
                          <tr><td style="font-family:Arial" align="right">No.of.Employees</td>
                          <td><strong>&nbsp;:&nbsp;</strong></td>
                          <td align="left"><asp:TextBox ID="txtemp" runat="server" Width="192px"></asp:TextBox></td>
                          </tr>
                          <tr><td></td></tr>
                          <tr>
                               <td colspan="3">
                                   <asp:ImageButton ID="btnAddMoreInfo" runat="server" AlternateText="AddMoreInfo" 
                                       ImageUrl="images/Post-More-Info.png" onclick="btnAddMoreInfo_Click1" />
                                   &nbsp;&nbsp;
                                   <asp:ImageButton ID="btnskip" runat="server" ImageUrl="images/Skip.png" 
                                       onclick="btnskip_Click" AlternateText="imgBtnSkip" />
                               </td>
                         </tr>
                        </table>
                    </td>
