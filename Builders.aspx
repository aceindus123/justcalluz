<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Builders.aspx.cs" Inherits="Builders" %>
...
<link_innerleft1:innerleft ID="content_inner" runat="server" />
<!-- ending the left -->
</div>
                     ...
                     <td colspan="4" class="side_menu" align="left" style="height:30px;">
                      ...
                      <%-- <tr>
                         <td align="center" style="height:30px;" colspan="3">
                          <asp:ImageButton ID="img1" runat="server" AlternateText="btnSend" ImageUrl="images/send-_button.png" PostBackUrl='<%# string.Format("sessionstoreS-" + Eval("id").ToString()+"-"+Eval("company_name").ToString()) %>' />
                         </td>
