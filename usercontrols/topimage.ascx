<%@ Control Language="C#" AutoEventWireup="true" CodeFile="topimage.ascx.cs" Inherits="usercontrol_topimage" %>
...
<a href="<%$RouteUrl:RouteName=HomeRoute%>" runat="server"><img alt="JustcalluzLogo" src="images/logo1.jpg" style="border:none;"></a>
</td>
...
<td align="right" valign="bottom" style="width:65px; padding-right:5px;"><a href="https://twitter.com/justcalluz" target="_blank"><img  style="vertical-align:middle; border:none; " alt="twitterIcon" src="images/Twitter-icon.png" width="24" height="20" /></a>
<a href="http://www.facebook.com/Justcalluz" target="_blank"><img style="vertical-align:middle; border:none; " alt="facebookIcon" src="images/facebook.png" width="24" height="20" /></a>
</td>
			</tr>
</table>
