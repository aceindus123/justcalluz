<%@ Control Language="C#" AutoEventWireup="true" CodeFile="catageories1.ascx.cs" Inherits="usercontrols_catageories" %>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="17%"><a href="<%$RouteUrl:RouteName=HomeTab,id=1%>" runat="server" target="_blank"><asp:Label ID="lblPCat" Text="Popular Search Categories" runat="server"></asp:Label></a></td>
    <td width="3%"><img src="../images/B2B-Categories.jpg" width="24" height="24" /></td>
    <td width="10%"><a href= "<%$RouteUrl:RouteName=HomeTab,id=2%>" runat="server" target="_blank"><asp:Label ID="Label1" Text="B2B Categories" runat="server"></asp:Label></a></td>
    <td width="3%"><img src="../images/Events.jpg" width="24" height="24" /></td>
    <td width="4%"><a href= "<%$RouteUrl:RouteName=Events,cname=events%>" runat="server" target="_blank"><asp:Label ID="Label2" Text="Events" runat="server"></asp:Label></a></td>
    ...
    <td width="7%"><%--<a href="Discounts.aspx?cname=discounts" style="color:#003366;"><asp:Label ID="Label3" Text="Discounts" runat="server" Font-Bold="false"></asp:Label></a>--%>
       <a href="<%$RouteUrl:RouteName=discounts,cname=discounts%>" runat="server" target="_blank"><asp:Label ID="Label3" Text="Discounts" runat="server"></asp:Label></a>
    </td>
    <td width="3%"><img src="../images/Hotels.jpg" width="24" height="24" /></td>
    <td width="4%"><a href="<%$RouteUrl:RouteName=Hotels,pageid=Hotels %>" runat="server" target="_blank"><asp:Label ID="Label4" Text="Hotels" runat="server"></asp:Label></a></td>
    <td width="3%"><img src="../images/JOBS.jpg" width="24" height="24" /></td>
    <td width="4%"><a href="<%$RouteUrl:RouteName=jobs,cname=jobs%>" runat="server" target="_blank"><asp:Label ID="Label5" Text="Jobs" runat="server"></asp:Label></a></td>
    ...
    <td width="6%"><%--<asp:Button ID="lnkbuild" runat="server" Text="Builders" CommandArgument="Builders" OnCommand="Category" BackColor="White" BorderStyle="None" CssClass="pointer" ></asp:Button>--%>
     ...
     <a id="A1" href="<%$RouteUrl:RouteName=Builders,cname=Builders%>" runat="server" target="_blank"><asp:Label ID="Label6" Text="Builders" runat="server"></asp:Label></a>
    </td>
