<%@ Control Language="C#" AutoEventWireup="true" CodeFile="boxes.ascx.cs" Inherits="usercontrol_boxes" %>
...
<asp:panel ID="Panel1" runat="server" BorderWidth="1" BorderColor="Blue"
        style=" position: absolute; width: 700px; height: 312px;  left: 58px; top: 255px;" 
        BackColor="White">
