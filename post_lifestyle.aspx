<%@ Page Language="C#" AutoEventWireup="true" CodeFile="post_lifestyle.aspx.cs" Inherits="post_lifestyle" %>
...
<tr>
    <td class="location"  height="35" style="padding-left:15px; background:url(images/search_midtop.png) no-repeat "><font color="white">Welcome to Just Call Uz :: LifeStyle</font></td>
  </tr>
</table>
</td>
  </tr>
    ...
    <td valign="top"> 
     <div class="events">
       <table width="100%" border="0" id="tblpost" runat="server">
              <tr>
                <td height="25" align="left" style="padding-left:10px;"><label style="color:#000" ><span class="sub_menu"><b>Post The Lifestyle </b></span></label>
  ...
  <tr id="trsubcat" runat="server" visible="false"><td align="right" class="style10"><span class="star">*</span> <span class="list">SubCategory</span> </td>
  <td align="center"><strong>:</strong></td>
  <td height="30" align="left"><span class="row"><asp:DropDownList ID="ddlsubcat" runat="server" 
          AutoPostBack="true" Height="21px" OnSelectedIndexChanged="ddlsubcat_selectedindexchanged" 
          Width="203px" ValidationGroup="postevent"></asp:DropDownList>
  ...
  <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
      ...
      <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
          ErrorMessage="Only numbers are allowed" ControlToValidate="txtpin" 
          ValidationExpression="\d{6}" ValidationGroup="postevent">*</asp:RegularExpressionValidator>  
                      </td>
                  </tr>
                  <tr>
  ...
  <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" 
          ...
          ValidationGroup="postevent">*</asp:RequiredFieldValidator></td>
                  ...
                  <tr>
                    <td align="right" class="style11"><span class="star">*</span> <span class="list">Email</span></td>
                    <td align="center" class="style12"><strong>:</strong></td>
                    <td align="left" class="style12"><asp:TextBox ID="txtemail" runat="server" Height="20px" 
  ...
  <b style="color:#093; font-size:11px;">(E.g:- 04066136226)</b><asp:RangeValidator ID="RangeValidator2" runat="server" 
          ...
          Width="165px" onkeypress="return onlyNos(event,this);" MaxLength="10" ValidationGroup="events"></asp:TextBox>
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                  ...
                  <tr>
                    <td height="30" colspan="3"><table width="100%" border="0">
                      <tr>
                        ...
                        <asp:ImageButton ID="postbtn" AlternateText="PostButton" runat="server" ImageUrl="../images/post-button.png"
          onclick="postbtn_Click" ValidationGroup="postevent" /></td>
                        <td width="24%" align="center"><asp:ImageButton AlternateText="ViewLifeStyleButton" 
                                ID="viewbtn" runat="server" ImageUrl="../images/view_lifestyle.png" 
                                PostBackUrl="<%$RouteUrl:RouteName=viewLife%>"/></td>
                        <td width="40%" align="left"><asp:ImageButton ID="cancel" AlternateText="CancelButton" runat="server" ImageUrl="../images/cancel-button.png" onclick="cancel_Click" /></td>
  ...
  <asp:Label ID="lblintimation" runat="server" Text="Do you want to post more information like Timings,upload logo,Upload Photos,Upload vedios etc.,?" Font-Bold="true"
   ...
   <tr><td></td></tr>
   <tr><td>
   <asp:ImageButton ID="imgbutclickhere" runat="server" AlternateText="ClickHereButton" 
           ImageUrl="../images/Click-here.png" onclick="imgbutclickhere_Click" />
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <asp:ImageButton ID="imgbutnothanks" runat="server" AlternateText="NoThanksButton" 
  ...
  <table width="100%">
                            <tr>
                                ...
                                <td>
                                <asp:ImageButton ID="btnUploadLogo" runat="server" AlternateText="UploadLogoButton" 
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <asp:FileUpload ID="uploadPhotos" runat="server" /><b style="color:#093; font-size:11px;">Photo must be 250x300 with less than 
      100kb of size</b>
                                </td>
                                <td>
                                <asp:ImageButton ID="btnUploadPhotos" runat="server" AlternateText="UploadPhotoButton" 
                                        ImageUrl="../images/Upload-Photos.png" onclick="btnUploadPhotos_Click1" />
                            ...
                            <tr>
                                ...
                                <td>
                                <asp:ImageButton ID="btnUploadVideos" runat="server" AlternateText="UploadVideoButton" 
                                        ImageUrl="../images/Upload-Video.png" onclick="btnUploadVideos_Click" />
                                   <%-- <asp:Button ID="btnUploadVedios" runat="server" Text="Upload Vedios" />--%></td>
                            ...
                            <tr id="trLstFri" runat="server">
                             ...
                             <tr id="trSunDur" runat="server">
                                  ...
                                  &nbsp;<%--<asp:LinkButton ID="lnkSunTimings" runat="server" ForeColor="Red" 
                                             onclick="lnkSunTimings_Click">Add Timings</asp:LinkButton>--%>
                             ...
                             <tr id="trLstSun" runat="server">
                                ...
                                <td>
                                  ...
                                  <td align="center"><strong>:</strong></td>
                                  <td align="left"><asp:DropDownList ID="ddlyearestablish" runat="server" Width="197px"></asp:DropDownList></td>
                                  </tr>
                                  ...
                                  <tr><td></td></tr>
                                   ...
                                   <tr>
                                       <td colspan="3" align="center">
                                           <asp:ImageButton ID="btnAddMoreInfo" runat="server" AlternateText="" 
