...
<title>Justcalluz| Planning your holiday or trip find the best places we provide updated information on all your local search</title>
<meta name='description' content='Things to do in your city,Top 10 places to see in hyderabad' />
<meta name='keywords' content='Justcalluz, Top places in Bangalore,Make my trip,Plan my Trip local businesses, yellow pages, online yellow pages, yellow pages india, India trade directory,  yellow pages directory, city yellow pages, indian search engine, JustCalluz customer care, JustCalluz customer support' />
<%--<title>Justcalluz - Categories View Page</title>--%>
<style type="text/css">
        .modalBackground
        {  
...
<asp:DataList ID="DLBindCatData" DataKeyField="id" runat="server" Width="100%" 
                  ...
                  <tr>
                    <td valign="middle" width="50%" colspan="2" class="sub_menu" style="padding:5px 5px 0px 10px; border-right-style:dashed; border-right-color:Gray; border-right-width:1px;" align="left">
                            <asp:HyperLink ID="hypCompany" runat="server" Text='<%# Eval("compname") %>' ToolTip='<%# Eval("company_name") %>' 
                                NavigateUrl='<%# string.Format("sessionstoreS-" + Eval("id").ToString()+"-"+Eval("company_name").ToString()) %>'></asp:HyperLink>
                         </td> 
                       ...
                       <%-- <asp:LinkButton ID="lnkBtnRatethis" runat="server"  PostBackUrl='<%# string.Format("PostReviewCat.aspx?DataId=" + Eval("id").ToString()) %>'>Rate This</asp:LinkButton>--%>                        
                      ...
                      <span class="side_menu">View Map</span>&nbsp;|&nbsp;<asp:HyperLink ID="hyp1" runat="server" Text="View Details"  NavigateUrl='<%# "sessionstore.aspx?id=" + Eval("id").ToString() %>'></asp:HyperLink>
                       ...
                       <%-- <tr>
                         <td style="padding-right:10px; padding-top:15px; height:30px;" colspan="6" align="right">
                          <asp:ImageButton ID="img1" runat="server" AlternateText="btnSend" ImageUrl="images/send-_button.png" PostBackUrl='<%# "sessionstore-" + Eval("id").ToString()+"-"+Eval("company_name").ToString() %>' />
                              <span class="side_menu"><asp:HyperLink ID="lnkmap" runat="server" ForeColor="#003366" CssClass="pointer">View Map</asp:HyperLink></span>&nbsp;|&nbsp;<asp:HyperLink ID="hyp1" runat="server" Text="View Details"  NavigateUrl='<%# "sessionstore-" + Eval("id").ToString() %>'></asp:HyperLink>
                         </td>
                      </tr>--%>
                     <tr><td>&nbsp;</td></tr>
                  </table> 
 ...
 <tr><td>&nbsp;<asp:Label ID="wilable" Width="45" runat="server"></asp:Label></td></tr>
