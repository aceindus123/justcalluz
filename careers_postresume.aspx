<%@ Page Language="C#" AutoEventWireup="true" CodeFile="careers_postresume.aspx.cs" Inherits="careers_postresume" %>
...
<head runat="server">
  ...
  <%--<title>:: Justcalluz :: careers PostResume Page </title>--%>
  <title>Submit Resume | JustCalluz</title>
	<meta name='Title' content='Submit Resume | JustCalluz' />
	<meta name='description' content='Submit your resume and apply for JustCalluz jobs by filling up personal and basic information. Suitable candidates will be chosen for further interview process in JustCalluz.' />
	<meta name='keywords' content='JustCalluz jobs, JustCalluz vacancies, submit resume in JustCalluz, apply for jobs in JustCalluz' />
...
<div class="content" style="padding:0; margin:0;">
  ...
  <tr>
     ...
     <span class="list">Application Title</span>
      ...
      <td width="71%" height="30" align="left">
        <asp:TextBox ID="txtTitle" runat="server" 
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator ID="rf1" runat="server" 
                  ...
                  ValidationGroup="careers_postresume">*</asp:RequiredFieldValidator>
      </td>
      </tr>
      <tr>
        ...
        <tr>
            ...
            <td height="30" align="left">
             ...
             <asp:RequiredFieldValidator ID="rf4" runat="server" ErrorMessage="please enter email address" 
                       ControlToValidate="txtEmailAddress" ValidationGroup="careers_postresume">*</asp:RequiredFieldValidator>
             <asp:RegularExpressionValidator ID="revEmailAddress" runat="server" 
                  ...
                  ValidationGroup="careers_postresume">*</asp:RegularExpressionValidator>
         </td>
         </tr>
         <tr>
            ...
            <td height="30" align="left">
             <asp:TextBox ID="txtHPhone" runat="server" 
                   Width="240px" MaxLength="11" style="margin-left: 9px" onkeypress="return onlyNos(event,this);"></asp:TextBox>
                   <b style="color:#093; font-size:11px;">(E.g:-02228884060 )</b> 
            ...
            <asp:RangeValidator ID="rvHPhone" runat="server" MaximumValue="1" MinimumValue="0" 
                    ...
                    ValidationGroup="txtHPhone"></asp:RangeValidator>
          </td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <asp:DropDownList ID="ddlcategory" runat="server" 
                    Width="243px" style="margin-left: 9px" 
       ...
       <asp:RequiredFieldValidator ID="rfvcategory" runat="server" 
                ...
                ValidationGroup="careers_postresume" InitialValue="select">*</asp:RequiredFieldValidator>
                 &nbsp;&nbsp;
         </td>
      </tr>
      <tr>
        <td align="right" width="25%"><span class="list">Specialization</span></td>
        <td align="center" width="4%"><strong>:</strong></td>
        <td height="30" align="left">
        <asp:DropDownList ID="ddlspecialization" runat="server" 
                    Width="243px" style="margin-left: 9px" AutoPostBack="false">
        </asp:DropDownList> 
            &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:RequiredFieldValidator ID="rfvspec" runat="server" 
             ErrorMessage="please select specialization" ControlToValidate="ddlspecialization" 
             ValidationGroup="careers_postresume" InitialValue="select">*</asp:RequiredFieldValidator>
                 &nbsp;&nbsp;
         </td>
       </tr>
       <tr>
        <td align="right" width="25%"><span class="list"> Work Experience</span></td>
        <td align="center" width="4%"><strong>:</strong></td>
        <td height="30" align="left">
        <table width="100%" border="0">
       <tr>
         ...
         <td class="select_menu" align="left" width="4%">Months</td>
         <td width="48%">&nbsp;</td>
     </tr>
     </table>
     </td>
   ...
   <tr>
        ...
        <td align="center"><strong>:</strong></td>
        <td height="30" align="left">
        <asp:DropDownList ID="ddlCTC" runat="server" 
                    Width="243px" style="margin-left: 9px">
        </asp:DropDownList>&nbsp;&nbsp;<asp:Label ID="lblannum" runat="server" Text="per annum"></asp:Label> 
        ...
        <tr>
           ...
           <asp:RequiredFieldValidator ID="rf8" runat="server" 
                  ErrorMessage="please select ECTC" ControlToValidate="ddlECTC" 
                  ValidationGroup="careers_postresume" InitialValue="select">*</asp:RequiredFieldValidator>
                 &nbsp;&nbsp; 
            </td>
          </tr>
          <tr>
           ...
           <td height="30" align="left">
            ...
            <asp:RequiredFieldValidator ID="rf9" runat="server" ErrorMessage="please select jobtype" 
               ControlToValidate="ddlJobtype" ValidationGroup="careers_postresume">*</asp:RequiredFieldValidator>
           </td>
          </tr>
          <tr>
        ...
        <tr>
         ...
         <tr>
               <td align="right" height="20" valign="top"><span class="list"> Upload Your CV</span></td>
                ...
                <asp:FileUpload ID="UploadCv" runat="server" 
                   ...
                   <asp:RequiredFieldValidator ID="rfvCV" runat="server" 
                     ...
                     ValidationGroup="careers_postresume">*<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      ...
      <tr>
        <td align="center">
        <asp:ImageButton ID="imgSave" AlternateText="save" ImageUrl="images/career-save.png" 
                 runat="server" OnClick="Save_click" ValidationGroup="careers_postresume" />
        </td>     
        </tr>
        <tr>
           <td align="center">
           <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
               ShowMessageBox="True" ShowSummary="False" ValidationGroup="careers_postresume" />
           </td>
        </tr>
        <tr>
           <td></td>
