<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EL_Busineskeywrds.aspx.cs" Inherits="EL_Busineskeywrds" %>
    ...
    <table width="100%" border="0">
      <tr>
        <td colspan="3"><p class="star">Whatever changes you make, will be taken live post 
            verification!     </tr>
      <tr>
        <td colspan="3"><p><strong>Business Keywords</strong></p></td>
        </tr>
      <tr>
        <td colspan="3"><p>For business keywords that you no longer wish to be listed in simply click on cross next to the keyword and when you are done, Click &quot;Save&quot;</p></td>
      </tr>
      <tr>
        <td colspan="3" align="right" style="padding-right:10px;"><a href="EL_AddKeywrds.aspx">Add More Keywords</a></td>
      </tr>
      <tr>
