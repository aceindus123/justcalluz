<%@ Page Language="C#" AutoEventWireup="true" CodeFile="linkcontroller.aspx.cs" Inherits="linkcontroller" %>
...
<%--<%@ Register Src="~/usercontrols/innerleft1.ascx" TagName="innerleft" TagPrefix="link_innerleft1" %>--%>
...
<%--<meta id="met1" runat="server" />
<meta id="met2" runat="server" />--%>
<style type="text/css">
        .modalBackground
        {  
                    ...
                    <tr><td colspan="3" height="10px"></td></tr>
                     ...
                     <td colspan="4" class="side_menu" align="left" style="height:30px;">
                       ...
                       <table width="100%" border="0">
                          <tr>
                            ...
                            <td width="81" align="left" valign="top">
                              <%--<asp:HyperLink ID="lnkmap" runat="server" ForeColor="#003366" CssClass="pointer">View Map</asp:HyperLink> --%>
                              <asp:LinkButton ID="lnkmap" runat="server" ForeColor="#003366" CommandArgument='<%# Eval("id") %>' 
                                                CssClass="pointer" OnCommand="lnkmap_Click">View Map</asp:LinkButton></td>
                          </tr>
                       </table></td></tr>
                       <%-- <tr>
                         <td align="right" style="height:30px; width:300px;" colspan="3">
                      ...
                      <%-- <tr>
                         <td style="padding-right:10px; padding-top:15px; height:30px;" colspan="6" align="right">
                          <asp:ImageButton ID="img1" runat="server" AlternateText="btnSend" ImageUrl="images/send-_button.png" PostBackUrl='<%# GetCompUrl(Eval("id"),Eval("company_name")) %>' />
                              <span class="side_menu"><asp:HyperLink ID="lnkmap" runat="server" ForeColor="#003366">View Map</asp:HyperLink></span>&nbsp;|&nbsp;<asp:HyperLink ID="hyp1" runat="server" Text="View Details" NavigateUrl='<%# GetViewUrl(Eval("id")) %>'></asp:HyperLink>
                         </td>
                      </tr>--%>
                    <%-- <tr><td>&nbsp;</td></tr>--%>
                  </table> 
