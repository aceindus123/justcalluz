<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LifeStyle_Link.aspx.cs" Inherits="LifeStyle_Link" %>
...
<!-- start the mid Box-->
  ...
  <div class="contentmid_boxtop"><a href="Default.aspx" style="color:White">Home</a>&gt;&gt; Lifestyle</div>
  <div class="contentmid_boxmid">
  <table width="537px" border="0">
  <tr>
    <td  height="30" align="center" class="headings" style="font-family:Arial;">Result for&nbsp;:&nbsp;&nbsp;LifeStyle</td>
    
  </tr>
   <tr>
    <td align="right"><asp:HyperLink ID="post" runat="server" Text="Advertise your company" Font-Size="11px" NavigateUrl="post_lifestyle.aspx" CssClass="side_menu" Font-Bold="true" ForeColor="Red" ></asp:HyperLink></td>
 ...
 <table><tr><td>
  ...
  <ItemTemplate>
     <table width="100%" border="0">
               <tr>
                <td  style="background:url(images/event_send3.png) no-repeat; width:500px; height:200px;" valign="top">
                 <div style="padding: 0px; margin: 0px;">
                   <table width="567px" border="0">
                    ...
                    <td width="40%" class="headings" style="font-family:Arial;">&nbsp;&nbsp;
                      <asp:Button  ID="Linkbutton1" ForeColor="Red" runat="server" 
                            PostBackUrl='<% #string.Format("LifeStyle_details.aspx?id=" + Eval("id").ToString())%>' 
                            Text ='<%# Eval("company_name") %>'  CommandName ="Select" BorderStyle="None"  />
                   </td>
                   <td width="35%" style="padding-left:4px; padding-top:5px; padding-right: 5px;" height="20" colspan="2" align="right">
              ...
              <span class="sub_menu" style="color:Black"><asp:Label ID="lblnoofratings" runat="server"></asp:Label>&nbsp; ratings</span>
                ...
                <tr>
                 ...
                 <asp:Image  ID="imglogo"  runat="server" AlternateText="CompanyLogo"  ImageUrl='<%# Eval("ImageName", "../Logos\\{0}") %>'  Width="100"  Height="85"/></td>
                    <td height="20" style="font-family:Arial;"><p><strong class="side_menu">Location</strong>&nbsp;:<span class="headings1"><asp:Literal ID="Literal2" runat="server" Text='<%#Eval("address")%>' /></span></p></td>
                 </tr>
                 <tr><td style="font-family:Arial;padding-left:5px;"><asp:Image AlternateText="phoneIcon" ID="imgmob" runat="server" ImageUrl="images/phone.png" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Literal ID="Literal1" runat="server" Text='<%#Eval("mob")%>'></asp:Literal></td></tr>
                  <tr><td align="left" style="font-family:Arial;padding-left:5px;"><asp:Image ID="imgmail" AlternateText="mailIcon" runat="server" ImageUrl="~/images/mail1.png" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Literal ID="Literal4" runat="server" Text='<%#Eval("emailid")%>'></asp:Literal> </td>
                  </tr>
                  <tr>
                   <td height="20" colspan="8" align="left" style="font-family:Arial;padding-left:5px;">
                   <td colspan="5" style="padding-left:5px;"><asp:Literal ID="Literal3" runat="server" Text='<%#Eval("city")%>'></asp:Literal></td>
                    </tr>
                    <table border="0" width="100%">
                    <tr>
                    <td></td><td colspan="5" style="padding-left:5px;"><asp:Literal ID="Literal3" runat="server" Text='<%#Eval("city")%>'></asp:Literal></td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
                    <td align="right" colspan="6">
                     <asp:HyperLink ID="lnkdetails" runat="server" Text="ViewDetails" NavigateUrl='<% #string.Format("LifeStyle_details.aspx?id=" + Eval("id").ToString())%>' ForeColor="Brown"></asp:HyperLink>
                    </td>
                    </tr>
                    </table>
                 </td>
                ...
                <td  style="background:url(images/event_send03.png) no-repeat; width:500px; height:200px;" valign="top">
                 <div style="padding: 0px; margin: 0px;">
                   ...
                   <%--   <asp:HyperLink  ID="hypCompName" ForeColor="Red" runat="server" NavigateUrl='<% #string.Format("LifeStyle_details.aspx?id=" + Eval("id").ToString())%>' 
                      ...
                      <asp:HyperLink  ID="hypCompName" ForeColor="Red" runat="server" NavigateUrl='<% GetCompyUrl(Eval("id"))%>' 
                            Text ='<%# Eval("compname") %>' ToolTip='<%# Eval("company_name") %>'></asp:HyperLink>
                   </td>
                 ...
                 <tr><td style="font-family:Arial;padding-left:5px;" width="80%" height="30"><asp:Image ID="imgmob" runat="server" ImageUrl="images/phone.png" />
                  ...
                  <tr>
                   ...
                   <%-- <tr>
                    ...
                    <tr>
                    <td>&nbsp;</td>
                    <td align="right" colspan="8" height="30" style="padding-right:5px;">
                     <asp:HyperLink ID="lnkdetails" runat="server" Text="ViewDetails" NavigateUrl='<% GetCompyUrl(Eval("id"))%>' ForeColor="Brown"></asp:HyperLink></td>
                    </tr>
                    </table>
                 </td>
                 </tr>
...
<div class="contentbox_mid">
  <table width="100%" border="0">
    <tr>
      ...
      <img src="images/lifestyleadd2 (1).png" alt="LifeStyleSponseredAds" width="175" height="600" /><br />
      <img src="images/lifestyleadd2 (2).png" width="175" alt="LifeStyleSponseredAds" height="300" /><br />
      </td>
    </tr>
    <tr>
      <td></td>
