<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Advertise_Edit.aspx.cs" Inherits="Advertise_Edit" %>
...
<tr>
    <td class="location"  height="35" style="padding-left:15px; background:url(images/search_midtop.png) no-repeat "><font color="white">
        Welcome to Just Call Uz :: Edit Advertisement</font></td>
  </tr>
</table>
</td>
          </tr>
        ...
        <tr>
          <td width="24%" align="right"> <span class="star">*</span><span class="list">Full 
              Name </span></td>
    ...
    ErrorMessage="please enter Name" ControlToValidate="txtfname" ValidationGroup="Advertise">*</asp:RequiredFieldValidator>
      ...
      <asp:TextBox ID="txtmob" runat="server" Width="190px" MaxLength="10" onkeypress="return onlyNos(event,this);"></asp:TextBox><b style="font-size:11px;">(E.g:- 09000465921)</b>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
       ErrorMessage="please enter valid Mobile Number" ControlToValidate="txtmob" 
            ValidationGroup="Advertise">*</asp:RequiredFieldValidator>
       ...
       <%-- <asp:RangeValidator ID="rvMob" runat="server" MaximumValue="1" MinimumValue="0" 
            ...
            ValidationGroup="Advertise">*</asp:RangeValidator>--%></span></td>
          </tr>
        <tr>
          <td align="right"><span class="list">Landline </span></td>
          <td align="center"><strong>:</strong></td>
          <td height="35" align="left">    <asp:TextBox ID="txtlanl" runat="server" Width="190px" MaxLength="11" onkeypress="return onlyNos(event,this);"></asp:TextBox><b style="font-size:11px;">(E.g:- 04066136226)</b></td>               
      ...
      <table width="100%" border="0">
        <tr>
          <td><table width="100%" border="0">
            <tr>
                    <td height="20" colspan="3" align="left" style="padding-left:10px;"><img src="images/pencil-icon.png" alt="pencil-icon" width="24" height="24" /><label style="color:#000" ><span class="sub_menu"><b>Business/ 
                        company information</b></span></label></td>
                  </tr>
                  <tr>
                    <td  colspan="3" ><hr/></td>
                    </tr>
                  <tr>
                    <td width="24%" align="right"><span class="star">*</span>&nbsp;<span class="list">Business 
                        Name</span></td>
                    <td width="3%" align="center"><strong>:</strong></td>
            ...
            ErrorMessage="please enter Business Name" ControlToValidate="txtbname" 
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td height="35" align="left"><span class="row">
                            <asp:TextBox ID="txtbProfile" runat="server" Width="190px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvbProfile" runat="server" 
            ErrorMessage="please enter Business Name" ControlToValidate="txtbProfile" 
                    ValidationGroup="Advertise">*</asp:RequiredFieldValidator>
                    </span></td>
                  </tr>
                   <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td height="35" align="left"><span class="row">
                            <asp:DropDownList ID="ddlCatType" runat="server" Width="190px" 
                              onselectedindexchanged="ddlCatType_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
                   ...
                   <tr>
                    ...
                    <td height="35" align="left"><span class="row">
                           <asp:DropDownList ID="ddlCategory" runat="server" Width="190px" 
                              onselectedindexchanged="ddlCategory_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
                          </asp:DropDownList>
                  ...
                  <tr>
                    ...
                    <td height="29" align="left">   <span class="row">
                      <asp:DropDownList ID="ddlSubCat" runat="server" Width="190px" Enabled="false">
                          </asp:DropDownList>
        ...
        <asp:RequiredFieldValidator ID="rfvAddress" runat="server" 
            ...
            ValidationGroup="Advertise">*</asp:RequiredFieldValidator>Enter the address</td>
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td height="35" align="left"><span class="row">
                   <asp:TextBox ID="txtArea" runat="server" Width="190px"  onkeypress="return Alphabets(event);"></asp:TextBox>
            ...
            ValidationGroup="Advertise">*</asp:RequiredFieldValidator>
                  ...
                  <tr>
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td height="35" align="left"> <asp:TextBox ID="txtPincode" runat="server" Width="190px" MaxLength="6" onkeypress="return onlyNos(event,this);"></asp:TextBox>
            ...
            ValidationGroup="Advertise">*</asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ...
                    ControlToValidate="txtPincode" ValidationExpression="[01]?[- .]?(\([1-9]\d{1}\)|[1-9]\d{1})[- .]?\d{2}[- .]?\d{2}$"
                    ValidationGroup="Advertise" Display="Dynamic"></asp:RegularExpressionValidator></td>
                  </tr>
                  <tr>
                    <td align="right"><span class="list">Fax</span></td>
                    <td align="center"><strong>:</strong></td>
                    <td height="35" align="left"> <asp:TextBox ID="txtFax" runat="server" Width="190px" MaxLength="11" onkeypress="return onlyNos(event,this);"></asp:TextBox><b style="font-size:11px;">(E.g:- 09000465921)</b>
      ...
      <ContentTemplate> 
        ...
        CaptchaMaxTimeout="200" Width="90px" />
          ...
          onclick="btnRefreshCapcha_Click" />
                    ...
                    <td align="center">&nbsp;</td>
                    <td height="40" align="left"><asp:ValidationSummary ID="ValidationSummary1" runat="server" 
          ShowMessageBox="True" ShowSummary="False" ValidationGroup="Advertise" /></td>
                  </tr>
                  <tr>
                  <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <asp:ImageButton ID="ImgBtnUpdateAdvertise" runat="server" AlternateText="UpdateButton" 
        ImageUrl="../images/update.png" ValidationGroup="Advertise" onclick="ImgBtnUpdateAdvertise_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <tr>
        ...
        <td width="28%">
            <asp:ImageButton ID="btnUploadLogo" runat="server" AlternateText="Upload-Logo" onclick="btnUploadLogo_Click" ImageUrl="images/Upload-Logo.png" />
        </td>
    </tr>
    <tr>
    <td colspan="2">&nbsp;</td>
    ...
    <tr>
        ...
        <td>
         <asp:ImageButton ID="btnUploadPhotos" AlternateText="Upload-Photos" runat="server" onclick="btnUploadPhotos_Click" ImageUrl="images/Upload-Photos.png" />
        </td>
    </tr>
    <tr>
    <td colspan="2"></td>
    <td colspan="2">
        <asp:DataList ID="dlPhotos" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
            ...
            <table>
              <tr>
                  <td align="center" class="side_menu">
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="lnkDelete" Text="Delete" runat="server" OnCommand="lnkPhotoDelete" BackColor="White" BorderStyle="None" 
                          CommandArgument='<%#Eval("id")%>' ForeColor="Blue" OnClientClick="return confirm('Are you sure to delete this Photo?')" />                                              
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:Button ID="lnkbtnChange" Text="Change/Add Caption" runat="server" BackColor="White" BorderStyle="None" 
                          OnCommand="lnkPhotoChangeCaption" CommandArgument='<%#Eval("id")%>' ForeColor="Blue" />   
    ...
    <%--<tr>
        ...
        <td>
            <asp:ImageButton ID="btnUploadVedios" AlternateText="Upload-Video" runat="server" onclick="btnUploadVedios_Click" ImageUrl="images/Upload-Video.png" />
            </td>
    </tr>--%>
    <%--<tr>
    <td colspan="2"></td>
            ...
            <table>
                <tr>
                    <td>                                            
                        ...
                        <asp:Image ID="Video" AlternateText="companyVideo" runat="server" Width="100px" Height="75px" ImageUrl='<%# Eval("VideoName", "../Videos\\{0}") %>' />                                                                             
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:Button ID="lnkDelete" runat="server" OnCommand="lnkPhotoDelete" Text="Delete" BackColor="White" BorderStyle="None" 
                          CommandArgument='<%#Eval("id")%>' ForeColor="Blue" OnClientClick="return confirm('Are you sure to delete this Photo?')" />                                               
                    </td>
                </tr>
            </table>                                                                        
            ...
            <td>
             <table width="100%">
              ...
              <tr id="trYrEstab" runat="server" class="side_menu">
                  ...
                  <td align="center"><strong>:</strong></td>
                  <td>
                      <asp:DropDownList ID="ddlYearEstab" runat="server" Width="192px">                                          
                      </asp:DropDownList>
                  </td>
              </tr>
              ...
              <tr id="trNoofEmp" runat="server" class="side_menu">
                  ...
                  <td align="center"><strong>:</strong></td>
                  <td>
                      <asp:DropDownList ID="ddlNoofEmp" runat="server" Width="192px">
              ...
              <tr>
                <td colspan="3" align="center">
                    <asp:ImageButton ID="btnAddMoreInfo" AlternateText="Post-More-InfoButton" runat="server" ImageUrl="images/Post-More-Info.png" 
                        onclick="btnAddMoreInfo_Click" ValidationGroup="HRO" />
                 
                        <asp:ImageButton ID="btnUpdateMoreInfo" AlternateText="Update-More-InfoButton" runat="server" Text="Update More Info" ImageUrl="images/Update-More-Info.png"
                        onclick="btnUpdateMoreInfo_Click" ValidationGroup="HRO"/>
                   &nbsp;&nbsp;
                    <asp:ImageButton ID="btnSkip" AlternateText="SkipButton" runat="server" ImageUrl="images/Skip.png"  onclick="btnSkip_Click" />
...
<div class="contentbox_mid">
  <table width="100%" border="0">
    <tr>
      ...
      <img src="images/event/add2.png" alt="AdvertiseAds" width="175" height="600" /><br />
        <img src="images/event/search-job-2.png" alt="AdvertiseAds" width="175" height="400" /><br />
     </td>
    </tr>
    <tr>
      <td></td>
