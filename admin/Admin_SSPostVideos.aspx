<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_SSPostVideos.aspx.cs" Inherits="admin_Admin_SSPostVideos" %>
                     ...
                     <tr>
                            <td colspan="2" align="right">
                                <asp:ScriptManager ID="ScriptManager1" runat="server">
                                 ...
                                 <a  target="_blank" href="http://www.justcalluz.com/success_videos.aspx" ><img src="images/Click Here For SiteView.png" alt="Site View" /></a>
                                        ...
                                        <td align="left" width="65%">
                                            <asp:DropDownList ID="ddlState" runat="server" 
                                             ...
                                             <asp:RequiredFieldValidator ID="rfddlState" runat="server" 
                                                ...
                                                InitialValue="Select State" ValidationGroup="PostSSVideo">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                        ...
                                        <td align="left" width="65%">
                                            <asp:DropDownList ID="ddlCity" runat="server" Width="200px">
                                             ...
                                             <asp:RequiredFieldValidator ID="rfvddlCity" runat="server" 
                                                ...
                                                InitialValue="Select City" ValidationGroup="PostSSVideo">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="1px"></td></tr>
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <AjaxToolkit:AutoCompleteExtender ID="autoselectCompany" runat="server" TargetControlID="txtCompanyName" MinimumPrefixLength="1"
                                             EnableCaching="true" CompletionSetCount="1" CompletionInterval="500" ServiceMethod="GetCompanyNames" ShowOnlyCurrentWordInCompletionListItem="false" 
                                             OnClientItemSelected="OnContactSelected" UseContextKey="true">
                                            </AjaxToolkit:AutoCompleteExtender>
                                            <asp:RequiredFieldValidator ID="rfvCompName" runat="server" 
                                                ErrorMessage="Please enter company name" 
                                                ControlToValidate="txtCompanyName" ValidationGroup="PostSSVideo">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="1px"></td></tr> 
                                    <tr class="adminform">
                                    ...
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvMonth" runat="server" 
                                                ...
                                                ValidationGroup="PostSSVideo">*</asp:RequiredFieldValidator>&nbsp;
                                    ...
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvPDesg" runat="server" 
                                                ...
                                                ControlToValidate="txtPDesg" ValidationGroup="PostSSVideo">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="1px"></td></tr>                                    
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                ...
                                                <asp:CustomValidator ID="CVImgUpload" runat="server" 
                                                    ...
                                                    onservervalidate="CVImgUpload_ServerValidate" ValidationGroup="PostSSVideo"></asp:CustomValidator>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                ...
                                                ValidationGroup="PostSSVideoVideo">*</asp:RequiredFieldValidator>
                                                <asp:CustomValidator ID="CVVideoUpload" runat="server" ErrorMessage="CV" ValidateEmptyText="true" 
                                                    ...
                                                    onservervalidate="CVVideoUpload_ServerValidate" ValidationGroup="PostSSVideo"></asp:CustomValidator>                                                    
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="5px"></td></tr>
                                    <tr>
                                        <td colspan="3" align="center">
                                            <asp:ImageButton ID="imgBtnPostSSVideo" runat="server" 
                                                ImageUrl="~/admin/images/post.png" 
                                                ValidationGroup="PostSSVideo" onclick="imgBtnPostSSVideo_Click" />
                                                <asp:ValidationSummary ID="valisummery" runat="server" ShowMessageBox="true" ShowSummary="false" ValidationGroup="PostSSVideo" />
                                        </td>
                                    </tr>                                 
                                </table>
                            </td>
