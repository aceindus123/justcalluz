<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_TopostMovies.aspx.cs" Inherits="admin_Admin_TopostMovies" %>
...
<title>Justcalluz - Admin Control Panel - Post Movies</title>
                ...
                <td valign="top" style="padding-left:10px; background-color:#F2FAFC">  
                    ...
                    <tr>
                        <td align="center" colspan="3">
                          <span style="font-size:21px; font-weight:bold; color:DarkBlue"> To Post Movies</span> 
                        </td>
                      </tr>                     
                ...
                <td colspan="2"> 
                    <table width="100%">                                     
                     ...
                     <tr>
                        ...
                        <td align="left">                            
                            <asp:DropDownList ID="ddlTheatre" runat="server" Width="206px" 
                                onselectedindexchanged="ddlTheatre_SelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList> 
                     ...
                     <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:RegularExpressionValidator ID="revURL" runat="server" 
                                ControlToValidate="txtURL" ErrorMessage="Please enter valid URL" ValidationGroup="PostMovieDetails" 
                     ...
                     <tr>
                      ...
                      <tr>            
                        <td align="center" colspan="3">
                            <asp:ImageButton ID="imgbtnPostMovie" runat="server" 
                                ImageUrl="~/admin/images/post.png" onclick="imgbtnPostMovie_Click" 
                                ValidationGroup="PostMovieDetails" /> 
                                <asp:ValidationSummary ID="thisumm" runat="server" ShowMessageBox="true" ShowSummary="false" ValidationGroup="PostMovieDetails" />
