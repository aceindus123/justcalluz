<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_ToPostCityTrendsMoredetails.aspx.cs" Inherits="admin_Admin_ToPostCityTrendsMoredetails" %>
...
<title>Justcalluz - Admin Control Panel - Post More details of City Trends </title>
                ...
                <td valign="top" style="padding-left:10px; background-color:#F2FAFC">  
                    ...
                    <tr><td height="5px"></td></tr>  
                        ...
                        <td align="center" colspan="2">
                          <span style="font-size:21px; font-weight:bold; color:DarkBlue"> Post More Details of Category 
                                ...
                                <tr id="trTitle" runat="server" height="40px">
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvTitle" runat="server" 
                                            ...
                                            ValidationGroup="PostCTMoreInfo">*</asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="20px" colspan="3" align="right">
                                         <asp:ImageButton ID="imgBtnLink" runat="server" ImageUrl="~/admin/images/link.gif" OnClientClick ="javascript:getSelText();" />                
                                    </td>
                                </tr>
                                <tr id="trDesc" runat="server">
                                    <td valign="top" class="adminform">
                                        Description
                                    </td>
                                    <td valign="top">
                                        :
                        ...
                        <tr>
                            <td colspan="3" align="center">
                                <asp:ImageButton ID="imgBtnPostMore" runat="server" 
                                    ImageUrl="~/admin/images/post.png"
                                    ValidationGroup="PostCTMoreInfo" onclick="imgBtnPostMore_Click" />
                            </td>
                        </tr> 
                         <tr>            
            <td>  
            <AjaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server"  
         PopupControlID="modpopup1" BackgroundCssClass="modalBackground" TargetControlID="imgBtnLink"
        OkControlID="imgBtnLink" CancelControlID="imgBtnLink" BehaviorID="mpeBehavior"
            ...
            <asp:Panel ID="Panel4" runat="server">
             ...
             <table align="center" width="400" style="background:white; height: 184px;" >               
               ...
               Link URL            
                ...
                <td>:</td>
                <td width="70%">
                    <asp:TextBox ID="txtLink" runat="server" Width="150px"></asp:TextBox><br />
                    <asp:RequiredFieldValidator ID="rfvNoofDays" runat="server" 
                        ErrorMessage="Please enter valid URL" 
                        ControlToValidate="txtLink" ValidationGroup="modal"></asp:RequiredFieldValidator>
                </td>
                </tr>
                 <tr>
                <td width="30%">                
              Title        
                ...
                <td>:</td>
                <td width="70%">
                    <asp:TextBox ID="txtLinkTitle" runat="server" Width="150px"></asp:TextBox><br />                    
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ErrorMessage="Please enter no. of days to extend job availability" 
                        ControlToValidate="txtLinkTitle" ValidationGroup="modal"></asp:RequiredFieldValidator>
                </td>
                </tr>
                <tr align="left" style="margin-left:5px">
                    <td align="center" class="style4" colspan="3">
                        <asp:Button ID="submitbutton" runat="server" Text="Submit" 
                            ValidationGroup="modal" Width="62px" 
                            OnClientClick ="javascript:Inserlink();" CausesValidation="False"/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
