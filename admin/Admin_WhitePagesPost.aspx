<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_WhitePagesPost.aspx.cs" Inherits="admin_Admin_WhitePagesPost" %>
...
<title>Justcalluz - Admin Control Panel -Post White Pages data</title>
            ...
            <table cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td valign="top" style="padding-left:10px; background-color:#F2FAFC">  
                    ...
                    <tr>
                        <td align="center" >
                          <span style="font-size:21px; font-weight:bold; color:DarkBlue">Post White Pages data</span> 
                        </td>
                      </tr>                     
                        ...
                        <tr>
                           ...
                           <%-- </td>
                            ...
                            <a href="Admin_WhitePages.aspx" style="text-decoration:underline;">Back</a>
                             <%--<asp:LinkButton ID="lnkBack" runat="server" Text="Back"  OnClientClick="javascript:window.location('Admin_WhitePages.aspx');" ></asp:LinkButton>--%>
                             </div>
                            </td>
                        </tr>                                                                           
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="50%" align="left">
                                            <asp:DropDownList ID="ddlPopCity" runat="server" Width="200px" 
                                                onselectedindexchanged="ddlPopCity_SelectedIndexChanged" AutoPostBack="true">
                                            </asp:DropDownList> 
                                            <asp:RequiredFieldValidator ID="rfvCity" runat="server" 
                                                ErrorMessage="Please select City" ControlToValidate="ddlPopCity" 
                                                InitialValue="Select City" ValidationGroup="postWP"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="50%" align="left">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvpara1" runat="server" 
                                                ...
                                                ValidationGroup="postWP"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>  
                                    <tr><td height="10px" colspan="3"></td></tr>
                                    <tr>
