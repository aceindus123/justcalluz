<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_CSREdit.aspx.cs" Inherits="admin_Admin_CSREdit" %>
      ...
      <script language="javascript" type="text/javascript">
          ...
          function confirm_delete(uid) {
              if (confirm("Are you sure you want to delete this Ad?") == true)
                  document.location = 'Admin_DeleteCSR.aspx?cid=' + uid;
              else
                  return false;
          }
                ...
                <td valign="top" style="padding-left:10px; background-color:#F2FAFC">  
                    ...
                    <tr>
                        <td align="center" colspan="3">
                          <span style="font-size:21px; font-weight:bold; color:DarkBlue">  Social Welfare Information - Update</span> 
                        </td>
                      </tr>                     
                                ...
                                <table width="100%">
                                    <tr>
                                        <td align="center">
                                         ...
                                         <span style="color:Red; font-weight:bold; font-size:20px;">Update Data regarding   Social Welfare Information</span>
                                        </td>
                                    </tr>  
                                    <tr><td height="5px"></td></tr>
                                    <tr>
                                    ...
                                    <tr><td height="5px" align="center"> <asp:RequiredFieldValidator ID="rfvTitle" runat="server" 
                                                ErrorMessage="Please enter title" ControlToValidate="txtTitle" 
                                                ValidationGroup="UpdateCSRData"></asp:RequiredFieldValidator></td></tr>   
                                    <tr>
                                        <td align="center">
                                    ...
                                    <tr><td height="5px" align="center"> <asp:RequiredFieldValidator ID="rfvPara1" runat="server" 
                                    ...
                                    <tr>
                                        <td align="center">
                                            <asp:ImageButton ID="imgBtnUpdateCSR" runat="server" 
                                    ImageUrl="~/admin/images/update.png"
                                    ValidationGroup="UpdateCSRData" onclick="imgBtnUpdateCSR_Click" />
                                    &nbsp; &nbsp;
