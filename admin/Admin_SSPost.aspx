<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_SSPost.aspx.cs" Inherits="admin_Admin_SSPost"%>
                                    ...
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvddlCity" runat="server" 
                                                ...
                                                InitialValue="Select City" ValidationGroup="PostSS">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="1px"></td></tr>                                     
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:TextBox ID="txtCompanyName" runat="server"   onkeyup = "SetContextKey()"  
                                                Width="200px" ontextchanged="txtCompanyName_TextChanged" AutoPostBack="true" onkeypress="return Alphabets(event);"></asp:TextBox>                                            
                                            ...
                                            <AjaxToolkit:AutoCompleteExtender ID="autoselectCompany" runat="server" TargetControlID="txtCompanyName" MinimumPrefixLength="1" EnableCaching="true"
                                             CompletionSetCount="1" CompletionInterval="500" ServiceMethod="GetCompanyNames" 
                                            ShowOnlyCurrentWordInCompletionListItem="false" OnClientItemSelected="OnContactSelected" UseContextKey="true">
                                            </AjaxToolkit:AutoCompleteExtender>
                                            <asp:RequiredFieldValidator ID="rfvCompName" runat="server" 
                                                ErrorMessage="Please enter company name" 
                                                ControlToValidate="txtCompanyName" ValidationGroup="PostSS">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="1px"></td></tr> 
                                    <tr class="adminform">
                                    ...
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvPName" runat="server" 
                                                ...
                                                ValidationGroup="PostSS">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="1px"></td></tr> 
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvPDesg" runat="server" 
                                                ...
                                                ControlToValidate="txtPDesg" ValidationGroup="PostSS">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="1px"></td></tr> 
                                    <tr class="adminform">
                                    ...
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvFirstyrInvestment" runat="server" 
                                                ...
                                                ErrorMessage="Please enter first year investment" ValidationGroup="PostSS">*</asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="1px"></td></tr> 
                                    <tr class="adminform">
                                        ...
                                        <td align="left" width="65%">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvuploadimg" runat="server" 
                                                ...
                                                <asp:CustomValidator ID="CVImgUpload" runat="server" 
                                                    ...
                                                    onservervalidate="CVImgUpload_ServerValidate" ValidationGroup="PostSS"></asp:CustomValidator>
                                        </td>
                                    </tr>
                                    <tr><td colspan="3" height="5px"></td></tr>
                                    <tr>
                                        <td colspan="3" align="center">
                                            <asp:ImageButton ID="imgBtnPostSS" runat="server" 
                                                ImageUrl="~/admin/images/post.png" 
                                                ValidationGroup="PostSS" onclick="imgBtnPostSS_Click" />
                                                <asp:ValidationSummary ID="validsummary1" runat="server" ShowMessageBox="true" ValidationGroup="PostSS" ShowSummary="false"  />
                                        </td>
                                    </tr>                                 
                                </table>
                            </td>
