...
<%@ Register Src="usercontrols/BottomMidContent.ascx" TagName="Contentmid" TagPrefix="aa5" %>
...
<head runat="server">
    ...
    <title> User Edit LifeStyle</title>
...
<tr>
  ...
  <td height="30" align="left"><span class="row"><asp:DropDownList ID="ddlcat" runat="server" Height="21px" 
          Width="206px" AutoPostBack="true" OnSelectedIndexChanged="ddlcat_selectedindexchanged"></asp:DropDownList>
      ...
      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
          ...
          InitialValue="select" ValidationGroup="userEdit">*</asp:RequiredFieldValidator>
          </span>
      </td>
 ...
 <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
   <td height="30" align="left"><span class="row"><asp:DropDownList ID="ddlsubcat" runat="server" 
          ...
          Width="206px" ValidationGroup="postevent" Enabled="false"></asp:DropDownList>
      <asp:RequiredFieldValidator ID="reqsubcat" runat="server" ControlToValidate="ddlsubcat" 
          ErrorMessage="Please select SubCategory" ValidationGroup="userEdit" 
          ...
          runat="server" AutoPostBack="true" 
           Height="21px" 
          Width="206px" OnSelectedIndexChanged="ddlstate_selectedindexchanged" 
          ></asp:DropDownList>
      <asp:RequiredFieldValidator ID="reqstate" runat="server" 
          ErrorMessage="Please select state" ControlToValidate="ddlstate"  
          ValidationGroup="userEdit" InitialValue="select">*</asp:RequiredFieldValidator>
                   </span></td>
                    </tr>
                  <tr>
           ...
           Height="21px" 
          Width="206px" ValidationGroup="events"></asp:DropDownList>
      ...
      <asp:RequiredFieldValidator ID="reqcmpnme" runat="server" 
          ErrorMessage="please specify the event name" ControlToValidate="txtevename"  ValidationGroup="userEdit">*</asp:RequiredFieldValidator></td>
                  </tr>
          ...
          Width="206px" TextMode="MultiLine" ValidationGroup="events"></asp:TextBox>
      <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" 
          ErrorMessage="Enter the address" ControlToValidate="txtadd"  ValidationGroup="userEdit">*</asp:RequiredFieldValidator></td>
                  </tr>
                  <tr>
                    <td align="right" class="style10"><span class="star"></span>&nbsp;<span class="list">LandMark</span></td>
                     <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtlndm" runat="server" Height="20px" Width="206px"></asp:TextBox></td>
                  </tr>
                  <tr>
                    <td align="right" class="style10"><span class="star">*</span>&nbsp;<span class="list">Pincode</span></td>
                     <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtpin" runat="server" Height="20px" Width="206px" MaxLength="6"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
                  ...
                  <tr>
                    <td align="right" class="style10"><span class="star">*</span><span class="list">&nbsp;Contact 
                        Person</span></td>
                     <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtcntp" runat="server" Height="20px" Width="206px"></asp:TextBox>
  <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" 
      ...
      <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
          ...
          ValidationGroup="userEdit" ControlToValidate="txtemail" >*</asp:RegularExpressionValidator></td>
                  </tr>
                  <tr>
                    <td align="right" class="style10"><span class="star"></span>&nbsp;<span class="list">LandLine</span></td>
                     <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtph" runat="server" Height="20px" Width="206px" MaxLength="11">
  ...
  <b style="color:#093; font-size:11px;">(E.g:- 04066136226)</b><asp:RangeValidator ID="RangeValidator2" runat="server" 
          ...
          ValidationGroup="userEdit">*</asp:RangeValidator>
          ...
          ValidationExpression="\d{11}">*</asp:RegularExpressionValidator></td>
                  ...
                  <tr>
                    <td align="right" class="style10"><span class="star">*</span>&nbsp;<span class="list">Mobile</span></td>
                     <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                   <%-- <td height="30" align="left" class="mid1_menu"><asp:TextBox ID="txtmob" runat="server" Height="20px" 
          Width="206px" MaxLength="11" ValidationGroup="events"></asp:TextBox>
          ...
          <b style="color:#093; font-size:11px;">(E.g:- 09000465921)</b>
      <asp:RangeValidator ID="RangeValidator1" runat="server" 
          ...
          ValidationExpression="\d{11}">*</asp:RegularExpressionValidator></td>--%>
           <td height="30" align="left" class="mid1_menu">
                    <asp:TextBox ID="txtcode" runat="server" ReadOnly="true" Text="+91" Width="30px"></asp:TextBox>-
                       <asp:TextBox ID="txtmob" runat="server" Width="165px" MaxLength="10"></asp:TextBox>
                     <%--<asp:RangeValidator ID="RangeValidator1" runat="server" 
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                       ErrorMessage="Only numbers are allowed for mobile" ValidationExpression="\d{10}" 
                       ValidationGroup="userEdit" ControlToValidate="txtmob">*</asp:RegularExpressionValidator>
                  ...
                  <tr>
                    <td align="right" class="style10"><span class="star"></span>&nbsp;<span class="list">fax</span></td>
                     <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                    <td height="30" align="left"><asp:TextBox ID="txtfax" runat="server" Height="20px" Width="206px" MaxLength="11"></asp:TextBox>
          ...
          ValidationExpression="\d{11}">*</asp:RegularExpressionValidator>
                  ...
                  <tr>
                    ...
                    <td height="30" align="left" class="mid1_menu"> <asp:TextBox ID="txtweb" runat="server" Height="20px" Width="206px"></asp:TextBox>
  <b style="color:#093; font-size:11px;">(E.g:- http://www.Justcalluz.com )</b>
      <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
          ...
          ValidationGroup="userEdit">*</asp:RegularExpressionValidator>
     
      <asp:ValidationSummary ID="ValidationSummary1" runat="server" 
          ValidationGroup="userEdit" ShowMessageBox="True" ShowSummary="False" /></td>
                  </tr>
                  <tr>
                  ...
                  <td colspan="3">
                              ...
                              <a id="lnkBtnClearFriTimings" runat="server" style="color:Red;" onserverclick="lnkBtnClearFriTimings_Click">Clear Timings</a>                                                                                                                                                                             
                                 ...
                                 <tr><td class="side_menu" colspan="3" style="font-size:medium; background-color:White" align="left">
                                  ...
                                  <td align="center"><strong>&nbsp;:&nbsp;</strong></td>
                                  <td align="left">
                                      <asp:DropDownList ID="ddlyearestablish" runat="server" Width="192px">
                                      </asp:DropDownList>
                                                                        </td>
                                  </tr>
  ...
  <tr><td></td></tr>
                  ...
                  <tr>
                    <td height="30" colspan="3"><table width="100%" border="0">
                      <tr>
                        <td width="36%" align="right" height="40" style="padding-right:3px;"><asp:ImageButton AlternateText="UpdateUserdata" ID="updatebtn" runat="server" ImageUrl="../images/update.png"
                              onclick="updatebtn_Click" ValidationGroup="postevent" /></td>
                        
                        <td width="40%" align="left">
                         <asp:ImageButton ID="cancel" runat="server" AlternateText="CancelUpdation" ImageUrl="../images/cancel-button.png" onclick="cancel_Click"/></td>
                      </tr>
                    </table></td>
                    </tr>
                  <tr>
...
<%-- <img src="images/event/add2.png" width="175" alt="SponserAds" height="600" />
 <img src="images/event/search-job-2.png" alt="SponserAds" width="175" height="300" />--%>
</div>
...
<aa5:Contentmid ID="mid1" runat="server" />
</div>
