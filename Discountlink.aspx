<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Discountlink.aspx.cs" Inherits="Discountlink" %>
...
<%@ Register Src="usercontrols/discount_left.ascx" TagName="innerleft" TagPrefix="DiscLink" %>
...
<%--<title>:: Justcalluz :: Discountlink page</title>--%>
...
<!-- start the inner left-->
  <DiscLink:innerleft ID="Dleft" runat="server"></DiscLink:innerleft>
...
<!-- start the mid Box-->
  ...
  <div>
  <div class="contentmid_boxtop"><%--<a href="Default.aspx" style="text-decoration:none;"><font color="white"> 
      Home</font></a>--%>
      <asp:HyperLink ID="hypDefault" runat="server" NavigateUrl="<%$RouteUrl:RouteName=HomeRoute%>" Text="Home" Font-Underline="false" ForeColor="White"></asp:HyperLink> &gt;&gt;
     <asp:Label ID="lblresultcat" runat="server" Text="Discounts"></asp:Label></div>
  ...
  <tr>
    ...
    <td width="51%" align="left"><strong class="side_menu">
       <asp:Label ID="lblcatresult" runat="server" Text="Discounts"></asp:Label></strong></td>
  </tr>
  <tr>
            ...
            <tr>
             ...
             <tr>
              ...
              <td width="23%" style="padding-left:5px;"><asp:ImageButton ID="go" runat="server" 
                      ImageUrl="images/go.png" onclick="go_Click" AlternateText="BtnGo" /></td>
            </tr>
          </table>
  ...
  <tr style="padding-left:30px">
    <td colspan="3" align="right"><asp:HyperLink ID="post" runat="server" Text="Post Your Discount" Font-Size="11px" NavigateUrl="<%$RouteUrl:RouteName=PostDiscount,cname=discounts%>" CssClass="side_menu" Font-Bold="true" ForeColor="Red" Font-Underline="false"></asp:HyperLink></td>
                                                                   
  </tr>
  <tr><td style="padding-left:5px;"  colspan="4">
    ...
    <td valign="top"  style="background:url(images/event_send03.png) no-repeat; height:200px;">
      <table width="100%" border="0">
            <tr>
                ...
                <td height="20" valign="top" align="right" style="padding-right:9px; padding-top:3px;"><strong class="sub_menu">
                 <asp:HyperLink ID="hypRatethis" runat="server" NavigateUrl='<%# GetUrlCat(Eval("id"))%>' Text="Rate this"></asp:HyperLink>
              </strong>
               </td>    
             </tr>
             <tr>
              <td colspan="15" height="118" style="padding-left:5px;" class="side_menu" valign="top"> 
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <table><tr>
                <td width="23%" rowspan="3" style="padding:10px 10px 10px 10px;" id="tdlogo" runat="server" visible="false">
                   <asp:Label ID="lblImgName" runat="server" Text='<%# Eval("ImageName") %>' Visible="false"></asp:Label>
                   <asp:Image  ID="imgReviewer"  runat="server"  ImageUrl='<%# Eval("ImageName", "../Logos\\{0}") %>' 
                        Width="99"  Height="68" AlternateText="imagReviewer"/>
                </td>
