<%@ Page Language="C#" AutoEventWireup="true" CodeFile="careersjobinfo.aspx.cs" Inherits="careersjobinfo" %>
...
<div class="category_box">
 ...
 <div class="content_innermid" style="width:79%;">
  ...
  <tr>
    ...
    <td width="51%">
      <asp:Image ID="imgPencial" AlternateText="SampleImage" ImageUrl="images/pencial.png" width="20" height="20" runat="server" />
          ...
          <tr style="font-size:small; background-color:#D5E6F9">
            ...
            <tr>
             <td colspan="3" align="center"> 
              <asp:ImageButton ID="btnapply" AlternateText="Apply" runat="server" ImageUrl="images/Apply_now.png" 
