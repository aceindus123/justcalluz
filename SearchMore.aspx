<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchMore.aspx.cs" Inherits="SearchMore" %>
...
<body>
    ...
    <div class="layout">    
<div class="signin">
<aa1:signin ID="SignIn11" runat="server" />
</div>
<div class="header">
<div class="header_logo"><S_logo:logo ID="logo12" runat="server" /></div>
<div class="header_search">
 <New:SearchNew ID="New1" runat="server" />
</div>
 </div>
<div class="category_box">
 <aa6:catag ID="uye1" runat="server" />
</div>
<!-- staart the Content-->
...
<table width="100%" border="0"  >
  ...
  <tr>
    ...
    <a id="A1" href="<%$RouteUrl:RouteName=HomeRoute%>" runat="server"><font style="padding-left:45px;">Home</font></a>>>
    <asp:Label ID="lblcat" runat="server"></asp:Label><br />
    <span class="side_menu" style="font-size:9pt; padding-left:30px;"><font>&nbsp;&nbsp;&nbsp;( Refine your search by clicking any of the links below )
    </font></span>
  ...
  <tr>
    ...
    <table width="100%">
    <tr>
    <td id="tdcat1" runat="server" valign="top">
    <%--<asp:Label ID="Label1" runat="server" CssClass="heading" ></asp:Label>--%>
    <asp:DataList ID="dlcat1" RepeatDirection="Vertical" Width="100%" CellPadding="4" runat="server" RepeatColumns="2">              
                <ItemTemplate>
    ...
    <%--<td id="tdcat2" runat="server" valign="top">
   
    <asp:DataList ID="dlcat2" RepeatDirection="Vertical" CellPadding="4" runat="server" RepeatColumns="1"  > 
    ...
    <%--<td id="tdcat3" runat="server" valign="top">
    
    <asp:DataList ID="dlcat3" RepeatDirection="Vertical" CellPadding="4" runat="server" RepeatColumns="1" > 
