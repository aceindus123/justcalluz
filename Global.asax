...
<script runat="server">
    ...
    void RegisterRoutes(RouteCollection routes)
    {
        ...
        routes.MapPageRoute("HomeRoute", "Home", "~/Default1.aspx");
        routes.MapPageRoute("HomeTab", "TabHome-{id}", "~/Default1.aspx");
        routes.MapPageRoute("cityhome", "C_Home-{city}", "~/Default1.aspx");
