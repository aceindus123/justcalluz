<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Events.aspx.cs" Inherits="Eventshome" %>
...
<!-- start the mid Box-->
  ...
  <div class="contentmid_boxtop"><asp:HyperLink ID="hyplink" runat="server" NavigateUrl="<%$RouteUrl:RouteName=HomeRoute %>" Text="Home" Font-Underline="false" ForeColor="White"></asp:HyperLink>&gt;&gt;Events</div>
          ...
          <td colspan="2" rowspan="2" valign="top" ><table width="100%" border="0">
            ...
            <tr>
              ...
              <td width="23%" style="padding-left:5px;"><asp:ImageButton ID="go" runat="server" 
                      ImageUrl="images/go.png" onclick="go_Click" AlternateText="imgeGo" /></td>
            </tr>
          </table>
 ...
 <%--<td width="81%" height="30">
  ...
  <tr>
    <td colspan="3" align="right" style="padding-right:2px"><asp:HyperLink ID="post" runat="server" Text="Post Your Event" Font-Size="11px" NavigateUrl="<%$RouteUrl:RouteName=postEvent,cname=events %>" Font-Underline="false" CssClass="side_menu" Font-Bold="true" ForeColor="Red" ></asp:HyperLink></td>
   </tr>
        ...
        <tr>
          <td valign="top"  style="background:url(images/event_send3.png) no-repeat top; width:536px; height:200px">
                  <%-- <table width="100%" cellpadding="0px" cellspacing="0px" border="0">
                    <tr>
                        <td class="dashboardbg" valign="top">--%>
                               <div style="padding: 0px; margin:0px">
                                      <table width="100%" border="0">
                                         ...
                                         <tr>
                                            ...
                                            <asp:Image  ID="imgReviewer" AlternateText="image" runat="server"  ImageUrl='<%# Eval("ImageName", "../Event_Images\\{0}") %>'  Width="99"  Height="68"/>
                                            </td>
                                            <td colspan="5">
                                            <table border="0" width="100%">
                                            <tr>
           ...
           <AjaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="friend" BackgroundCssClass="modalbackground" PopupControlID="friendpanel" OkControlID="cancel" DropShadow="false" PopupDragHandleControlID="panel1">
...
<td colspan="3" align="center" valign="top" 
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <asp:ImageButton ID="cancel" ImageUrl="../images/panel/cencel.png" width="21" height="22" runat="server" AlternateText="imgeCancel"/></td>
</tr>
<tr>
  <td height="184" colspan="3">
     <table align="center" width="350px" style="height: 170px;">
      <tr>
...
<tr>
  ...
  <td width="110" align="right" style="padding:5px 10px 5px 5px;">
  <asp:ImageButton ID="imggo" OnClick="imggo_Click" ImageUrl="../images/panel/dialog_buttan.png" width="98" height="35" 
               runat="server" ValidationGroup="share" AlternateText="imgeGo"/></td></tr>
</table>
</div>
</asp:Panel>
      </div>
